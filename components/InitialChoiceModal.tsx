...
const BackupIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8 mb-2 text-purple-400">
        <path strokeLinecap="round" strokeLinejoin="round" d="M3 16.5v2.25A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75V16.5m-13.5-9L12 3m0 0 4.5 4.5M12 3v13.5" />
    </svg>
);

const UserIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-10 h-10 mb-2 text-cyan-400">
            ...
            <div className="bg-slate-900 text-white rounded-3xl shadow-2xl w-full max-w-3xl border border-slate-700 overflow-hidden relative">
                ...
                <header className="p-8 text-center border-b border-slate-800 bg-slate-900/50">
                    <div className="flex justify-center items-center gap-3 mb-2">
                        <img src="/logo.png" alt="Logo" className="w-10 h-10 rounded-xl shadow-lg border border-slate-700" />
                ...
                <div className="p-8">
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
                        ...
                        {/* OPZIONE 1: NUOVO UTENTE (Primary) */}
                        <button 
                            onClick={onStartNew}
                            className="flex flex-col items-center justify-center p-6 bg-cyan-600/10 hover:bg-cyan-600/20 border-2 border-cyan-500/50 hover:border-cyan-400 rounded-2xl transition-all group scale-105 shadow-xl z-10"
                        >
                        ...
                        <button 
                            ...
                            className="flex flex-col items-center justify-center p-6 bg-slate-800/50 hover:bg-slate-800 border border-slate-600 hover:border-purple-500 rounded-2xl transition-all group"
                        >
                            <div className="group-hover:scale-110 transition-transform duration-300">
                                <BackupIcon />
                            </div>
                        ...
                        <button 
                            onClick={onClose}
                            className="flex flex-col items-center justify-center p-6 bg-slate-800/50 hover:bg-slate-800 border border-slate-600 hover:border-slate-400 rounded-2xl transition-all group"
                        >
                            <div className="group-hover:scale-110 transition-transform duration-300">
                                <MapIcon />
                            </div>
