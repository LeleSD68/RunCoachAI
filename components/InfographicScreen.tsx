    ...
    return (
        <div className="fixed inset-0 z-[50000] bg-slate-950 flex flex-col items-center justify-center overflow-hidden">
            ...
            <img 
                ...
                className="absolute inset-0 w-full h-full object-contain p-4 pb-32 block md:hidden landscape:hidden animate-appear"
            />
            ...
            <img 
                ...
                className="absolute inset-0 w-full h-full object-contain p-4 pb-32 md:p-8 md:pb-32 hidden md:block landscape:block animate-appear"
            />
