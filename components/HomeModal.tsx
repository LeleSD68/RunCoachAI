...
const ChatSocialIcon = () => (<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5"><path d="M4.913 2.658c2.075-.27 4.19-.408 6.337-.408 2.147 0 4.262.139 6.337.408 1.922.25 3.291 1.861 3.405 3.727a4.403 4.403 0 0 0-1.032-.211 50.89 50.89 0 0 0-8.42 0c-2.358.196-4.04 2.19-4.04 4.434v4.286a4.47 4.47 0 0 0 2.433 3.984L7.28 21.53A.75.75 0 0 1 6 21v-2.351a4.494 4.494 0 0 0-2.139-3.862 13.946 13.946 0 0 0-1.106-6.502c.433-2.615 2.139-5.402 2.158-5.627Zm6.077 8.01c-1.355 0-2.54.89-2.54 1.989v.213c0 1.098 1.185 1.989 2.54 1.989 1.355 0 2.54-.89 2.54-1.99v-.212c0-1.098-1.185-1.989-2.54-1.989Z" /><path fillRule="evenodd" d="M12.552 6.533a3.507 3.507 0 0 0-1.047-.134 49.337 49.337 0 0 0-8.42 0C2.463 6.452 1.5 6.945 1.5 8.07 1.5 10.521 3.262 12.7 5 14.163a2.535 2.535 0 0 0 1.13.435 6.402 6.402 0 0 1-.954.912c-1.294 1.077-1.43 2.164-.26 2.37.917.158 1.93.308 2.87.308.286 0 .584-.04.915-.12a6.47 6.47 0 0 1 3.844-3.513v-8.02Z" clipRule="evenodd" /></svg>);
                            ...
                            <div className="mt-auto pt-4 border-t border-slate-800/50 flex items-center justify-between gap-2 overflow-x-auto pb-2 md:pb-0 no-scrollbar">
                                <div className="flex gap-2">
                                    ...
                                    <button onClick={onOpenSettings} className="flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-slate-800 text-slate-400 hover:text-white transition-colors border border-transparent hover:border-slate-700">
                                        <CogIcon /> <span className="text-xs font-bold uppercase">Settings</span>
                                    </button>
