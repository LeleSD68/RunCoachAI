                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-2 md:gap-4 auto-rows-min w-full max-w-4xl mx-auto">
                            ...
                            <div className="col-span-2 md:col-span-4 mt-1 md:mt-2 grid grid-cols-4 md:grid-cols-6 gap-2">
                                ...
                                <button 
                                    ...
                                    className={`bg-slate-800/60 border border-slate-700 rounded-xl md:rounded-2xl p-2 md:p-3 flex flex-col items-center justify-center gap-1 transition-colors group ${isGuest ? 'hover:bg-green-900/20 hover:border-green-900/50' : 'hover:bg-red-900/20 hover:border-red-900/50'}`}
                                >
                                    <span className={isGuest ? "text-green-400" : "text-red-400"}>{isGuest ? <LoginIcon /> : <LogoutIcon />}</span> 
                                    <span className={`text-[8px] md:text-[9px] font-bold uppercase text-slate-400 group-hover:${isGuest ? 'text-green-400' : 'text-red-400'}`}>{isGuest ? 'Login' : 'Logout'}</span>
                                </button>
