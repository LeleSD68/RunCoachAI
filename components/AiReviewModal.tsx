        ...
        const generateReview = async () => {
            try {
                ...
                if (track.linkedWorkout) {
                    contextStr = `
                    CONTESTO IMPORTANTE: Questa corsa doveva seguire l'allenamento pianificato "${track.linkedWorkout.title}":
                    "${track.linkedWorkout.description}".
                    Il voto riflette quanto l'atleta ha rispettato queste consegne.
                    `;
                }

                const prompt = `${personalityPrompts[personality] || personalityPrompts['pro_balanced']} 
                ...
                - Analizza PERCHÉ questo allenamento merita ${track.rating} stelle. Sii specifico su questa sessione, non generalizzare.
                - Limite parole: Massimo 450 parole.
                - Sii estremamente SINTETICO, professionale ed esaustivo.
                
                Analizza:
                1. Aderenza all'obiettivo (se presente).
                2. Gestione dello sforzo (Cardio/Passo).
                3. Efficienza in salita (se rilevante).
                `;
