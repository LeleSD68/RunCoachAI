...
const UnarchiveIcon = () => (<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-4 h-4"><path fillRule="evenodd" d="M2 3a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V3Zm10 13c0 1.1.9 2 2 2h3a2 2 0 0 0 2-2v-3a2 2 0 0 0-2-2h-3a2 2 0 0 0-2 2v3Zm-9-3.25a.75.75 0 0 1 .75.75v2.75H6a.75.75 0 0 1 0 1.5H3a.75.75 0 0 1-.75-.75V13.5a.75.75 0 0 1 .75-.75ZM10 7a.75.75 0 0 1 .75.75v3.5a.75.75 0 0 1-1.5 0v-3.5A.75.75 0 0 1 10 7ZM7.22 9.28a.75.75 0 0 1 1.06 0l1.72 1.72 1.72-1.72a.75.75 0 1 1 1.06 1.06l-2.25 2.25a.75.75 0 0 1-1.06 0l-2.25-2.25a.75.75 0 0 1 0-1.06Z" clipRule="evenodd" /></svg>);
const RestoreIcon = () => (<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-4 h-4"><path fillRule="evenodd" d="M3.25 3.25a.75.75 0 0 1 .75.75v7.25h6.25a.75.75 0 0 1 0 1.5H4a2.25 2.25 0 0 1-2.25-2.25V4a.75.75 0 0 1 .75-.75Zm11.28 1.47a.75.75 0 0 1 1.06 0l2.25 2.25a.75.75 0 0 1 0 1.06l-2.25 2.25a.75.75 0 1 1-1.06-1.06l.97-.97H8.75a.75.75 0 0 1 0-1.5h6.72l-.97-.97a.75.75 0 0 1 0-1.06Z" clipRule="evenodd" /></svg>);
                                    ...
                                    <div className="flex items-center gap-1 ml-2">
                                        <Tooltip text={track.isArchived ? "Ripristina" : "Archivia"}>
                                            <button 
                                                ...
                                                className={`p-1.5 rounded-md transition-colors ${track.isArchived ? 'bg-green-600 hover:bg-green-500 text-white' : 'text-slate-400 hover:text-white hover:bg-slate-700'}`}
                                            >
                                                {track.isArchived ? <RestoreIcon /> : <ArchiveBoxIcon />}
                                            </button>
                                        </Tooltip>
